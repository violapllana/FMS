    ...
    <>
      ...
      <div className="bg-gray-50 flex items-center justify-center py-12">
        <div className="w-full max-w-lg">
          ...
          {/* New colored section above the form */}
        <section className="bg-blue-100 text-blue-800 p-6 rounded-t-lg shadow-md mb-4">
  <h3 className="text-xl font-semibold mb-2">Need Assistance? FMS is Here to Help!</h3>
  <p>
    Fill out the form below to send us your questions, feedback, or support requests regarding the Faculty Management System (FMS). We'll respond as quickly as possible.
  </p>
</section>


          {/* Form container with white bg and rounded bottom corners */}
