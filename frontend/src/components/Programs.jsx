  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 py-12 px-4">
        <h1 className="text-4xl font-extrabold text-center mb-10 text-gray-800">Academic Programs</h1>
        ...
        <div className="max-w-7xl mx-auto grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {programs.map((prog, index) => (
            ...
            >
              <h2 className="text-xl font-bold mb-2 text-indigo-600">{prog.title}</h2>
              <p className="text-sm text-gray-500 mb-4 font-medium">{prog.duration}</p>
